...
const LandingSection = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.item}>
                <p>Hi, I'm Josh and I'm currently a software engineer and iOS developer for T-Mobile.
                    Through my work I've grown a passion for UI development, and worked in diverse teams to improve 
                    the user experience for several consumer facing applications.</p>
                <p>
                    ...
                    in original and challenging personal projects.</p>
                    <p>
                    ...
                    and universal experiences in my work.</p>
            </div>
